...
Sys.time()
test_ls <- fast_ls_perc(size = 25, prop = 0.25, cluster = 10)
Sys.time()
...
It works! Much faster. But can it be made faster by changing the for loop to a while loop and modifying the rate at which cells are filled from one at a time to higher?
