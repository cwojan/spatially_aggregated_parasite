...
This document features code to run simulations across 144 landscapes (of varying parasite density and spatial aggregation) with different recovery rates, with high replication.
...
write_rds(big_sims, str_c("sim_output/recov_sims_", timestamp, ".rds"))
